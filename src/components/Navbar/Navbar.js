        ...
        <div className='w-full bg-[#a3f1ec] relative z-20'>
            <div className="navbar container mx-auto max-w-screen-xl mb-4 md:mb-10 py-2 md:py-5 justify-between">
                <div className='hidden md:flex gap-3'>
                    ...
                    <Link to='/'><p className='text-3xl font-bold'>Smiley</p></Link>
                </div>
                ...
                <div className='md:hidden'>
                    <div className="dropdown dropdown-end">
                        ...
                        <ul tabIndex={0} className="menu menu-compact dropdown-content mt-2 p-2 shadow bg-base-100 rounded-box w-52 font-medium">
                            ...
                            {(userInfo && userInfo?.uid) ?
                                <>
                                    ...
                                    <li title={userInfo?.displayName || userInfo?.email}>
                                        <Link>Profile</Link>
                                    </li>
